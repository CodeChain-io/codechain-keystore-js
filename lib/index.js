...
function createKeyStore(context, keyType) {
    return {
        getKeys: function () {
            return keys_1.getKeys(context, { keyType: keyType });
        },
        importRaw: function (params) {
            return keys_1.importRaw(context, __assign({}, params, { keyType: keyType }));
        },
        exportKey: function (params) {
            return keys_1.exportKey(context, __assign({}, params, { keyType: keyType }));
        },
        importKey: function (params) {
            return keys_1.importKey(context, __assign({}, params, { keyType: keyType }));
        },
        createKey: function (params) {
            return keys_1.createKey(context, __assign({}, params, { keyType: keyType }));
        },
        deleteKey: function (params) {
            return keys_1.deleteKey(context, __assign({}, params, { keyType: keyType }));
        },
        sign: function (params) {
            return keys_1.sign(context, __assign({}, params, { keyType: keyType }));
        }
    };
}
