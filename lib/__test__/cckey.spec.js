...
test("platform.importRaw", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                key = _a.sent();
                expect(key).toBe("0eb7cad828f1b48c97571ac5fde6add42a7f9285a204291cdc2a03007480dc70639d80c57d80ba6bb02fc2237fec1bb357e405e13b7fb8ed4f947fd8f4900abd");
                return [2 /*return*/];
        }
    });
}); });
...
test("platform.deleteKey", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                key2 = _a.sent();
                return [4 /*yield*/, cckey.platform.deleteKey({ publicKey: key1 })];
            case 3:
                _a.sent();
                return [4 /*yield*/, cckey.platform.getKeys()];
            case 4:
...
test("mapping.add", function () { return __awaiter(_this, void 0, void 0, function () {
    var value;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, cckey.mapping.add({ key: "satoshi", value: "nakamoto" })];
            case 1:
                _a.sent();
                return [4 /*yield*/, cckey.mapping.get({ key: "satoshi" })];
            case 2:
                value = _a.sent();
