...
function createKey(context, params) {
    var privateKey = codechain_primitives_1.generatePrivateKey();
...
function createPublicKeyFromPrivateKey(context, params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    publicKey = codechain_primitives_1.getPublicFromPrivate(params.privateKey);
                    passphrase = params.passphrase || "";
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    privateKey = storage_1.decode(JSON.parse(key.secret), params.passphrase);
                    _a = codechain_primitives_1.signSchnorr(params.message, privateKey), r = _a.r, s = _a.s;
                    sig = "" + _.padStart(r, 64, "0") + _.padStart(s, 64, "0");
                    return [2 /*return*/, sig];
            }
        });
    });
